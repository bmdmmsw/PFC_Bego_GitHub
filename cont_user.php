...
mysqli_connect($host,$user,$pass) or die('No se puede conectar al servidor.' );     
                                                    
mysqli_db_query($dbname, "INSERT INTO useronline VALUES ('$tiempo','$remoteAdd','$phpSelf')") or die("ERROR DEL INSERT");

mysqli_db_query($dbname, "DELETE FROM useronline WHERE tiempo<$timeout") or die("ERROR AL BORRAR");
