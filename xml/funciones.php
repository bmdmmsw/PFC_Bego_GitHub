...
//////////MENU/////////
	...
	function notLogged() {							
        return "<nav class='main' id='n1' role='navigation'>
					...
					<span><a href='cambiarPass.php.html'>Cambiar Contraseña</a></span>
	...
	function logged($tipo) {
		if ($tipo=='A'){
			return "<nav class='main' id='n1' role='navigation'>
						<span><a href='index.php'>Inicio</a></span>
						<span><a href='index.php'>Gestionar Preguntas</a></span>
						<span><a href='quizes.html'>Preguntas</a></span>
						<span><a href='creditos.html'>Creditos</a></span>
					</nav>";			
		}else{
			return "<nav class='main' id='n1' role='navigation'>
						<span><a href='index.php'>Inicio</a></span>
						<span><a href='index.php'>Revisar Preguntas</a></span>
